...
## Datos del Aprendiz
**Nombre:**Lizeth Dayana Ávila Hernández
**Ficha:** 3407186
...
El proyecto consiste en el desarrollo de una API REST utilizando FastAPI para la gestión de clientes, facturas y transacciones.
